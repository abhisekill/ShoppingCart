...
router.get('/products/:id/edit',isLoggedIn,isAllowed, async(req,res)=>{
    try{
...
// delete a product
router.delete('/products/:id',isLoggedIn,isAllowed, async(req,res)=>{
   
    try{
        await Product.findByIdAndDelete(req.params.id);
        await User.findByIdAndUpdate(req.user._id,{$pull:{cart:req.params.id}});
